    ...
    await _scanController.processScan(() async {
      try {
        ...
        if (widget.searchStatus != null) {
          ...
          final result = await provider.searchGuide(
            cleanGuide,
          ...
          if (result != null) {
            ...
            if (result.stateLabel == widget.searchStatus) {
              ...
              final isValidated = provider.getGuideUiState(cleanGuide) == 'validated';
              ...
              if (!isValidated) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('ℹ️ Guía $cleanGuide ya está validada para despacho'),
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('⚠️ La guía $cleanGuide no se encuentra registrada en el sistema'),
